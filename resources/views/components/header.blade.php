<header class="glass-header" id="main-header">
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li><a href="{{ route('home') }}#inicio" class="{{ request()->routeIs('home') ? 'nav-inicio' : '' }}">Inicio</a></li>
            ...
            <li><a href="{{ route('nosotros') }}" class="{{ request()->routeIs('nosotros') ? 'nav-inicio' : '' }}">Nosotros</a></li>
